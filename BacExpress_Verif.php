...
//	echo "<BR>ThemeS=".$ThemeS;
    ...
    $nombreDeMots = count(file($cheminFichierTheme, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES));
	...
	echo "\r\n	<input type=\"hidden\" id=\"scoreHidden\" name=\"scoreHidden\" value=\"".$score."\">";
