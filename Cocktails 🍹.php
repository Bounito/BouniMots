...
$lignesAuHasard = fctRandMots('Cocktails.txt',9);
$i=0;
...
fctAfficheEntete("Quel cocktail pour cette recette ?");
...
for ($i=0;$i<$nbMots;$i++) {
    echo "<DIV class='flex-3x3'>";
        echo "\n<DIV class='flex-bouton' id='sol".$i."' onclick=\"clicDivBouton(this,'$motChoisi','".$tableauDonnees[$i]['Marque']."','monFormulaire',0,8,".$_SESSION['WinStreak'].");\">";
            ...
            echo "<IMG width=100% src='".fctBingSrc("Cocktail ".str_replace("'","",$tableauDonnees[$i]['Marque']),600)."' />";
            echo "</DIV>";
